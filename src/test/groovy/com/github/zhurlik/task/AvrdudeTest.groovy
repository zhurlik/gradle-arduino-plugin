...
class AvrdudeTest {
    ...
    void setUp() {
        ...
        testProject.tasks.create('testTask', Avrdude) {
            options.add('--help')
        }
    }
    ...
    @Test
    void testMain() {
        assertEquals('[--help]', testProject.tasks['testTask'].options.toString())
        ...
        assertTrue(exp.getMessage().contains("A problem occurred starting process 'command '/test/arduino-ide/hardware/tools/avr/bin/avrdude"))
    }
}
