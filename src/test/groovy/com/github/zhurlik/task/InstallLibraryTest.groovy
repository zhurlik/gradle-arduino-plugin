...
class InstallLibraryTest {
    ...
    void setUp() {
        ...
        testProject.tasks.create('testTask', InstallLibrary) {
            libraryName = '"Bridge:1.0.0,Servo:1.2.0"'
        }
    }
    ...
    void testMain() {
        ...
        assertTrue(exp.getMessage().contains("A problem occurred starting process 'command '/test/arduino-ide/arduino"))
    }
}
